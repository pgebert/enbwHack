...
FLAGS.demo = "/home/ubuntu/Case1/Biberach_1/Marktplatz-20180412-111303.mp4" # video file to use, or if camera just put "camera"
...
FLAGS.threshold = 0.20 # threshold of decetion confidance (detection if confidance > threshold )
