$(window).load(function() {
    ...
    for (i = 1; i < nbrFrames; i++) {
        (new Image()).src = 'web/data/video/out' + i + '.png';
    }
...
(function($) {
    $(function() {
        ...
        (function imageSetup() {
            ...
            img.style.width = '100%';
            img.src = "web/data/video/out1.png";
            document.getElementById('video').appendChild(img);
            videoFrame = img;
        })();

        function show(frameID) {
            videoFrame.src = "web/data/video/out" + frameID + ".png";
        ...
        function person_card(personID) {
            return [
                ...
                '<div class="col s4 m2"><img src="web/img/avatar/' + avatarIcons[personID % avatarIcons.length] + '" alt="" class="circle responsive-img valign"></div>',
